...
- Flutter app under [`mobile/app`](mobile/app) (iOS + Android, one Dart codebase). Desktop stays PyQt6.
...
- Android APK via `flutter build apk`. Play Store later if it is useful.
