...
## Philosophy
> "Code involves people, not just patterns."

While this directory enforces a strict metadata schema, the *content* of the feature requests should focus on **User Value** and **Implementation Speed**. Do not over-architect the solution in the spec.
